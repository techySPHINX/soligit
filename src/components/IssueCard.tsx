      ...
      <Modal open={open} setOpen={setOpen}>
        ...
        <form className="mt-4" onSubmit={handleSubmit}>
          <div>
            ...
            Soligit has context about this issue and the meeting
            </span>
            {answer && (
              <>
          ...
          <Button disabled={askIssue.status === "pending"} className="mt-3 w-full">
            {askIssue.status === "pending" ? "Sending..." : "Send Question"}
          </Button>
        </form>
      </Modal>
